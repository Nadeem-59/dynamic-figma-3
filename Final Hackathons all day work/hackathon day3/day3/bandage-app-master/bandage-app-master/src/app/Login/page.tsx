        ...
        <div className="md:max-w-md w-full px-4 py-4">
          <form>
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 mt-6">
              ...
              <div>
                <a href="jajvascript:void(0);" className="text-sky-500 font-semibold text-sm hover:underline">
                  Forgot Password?
                </a>
              </div>
            </div>
            ...
            <div className="mt-12">
              <button type="button" className="w-full shadow-xl py-2.5 px-4 text-sm tracking-wide rounded-md text-white bg-sky-500 hover:bg-blue-500 focus:outline-none">
                Sign in
              </button>
            </div>
            ...
            <div className="space-x-6 flex justify-center mt-6">
              ...
              <button type="button"
                className="border-none outline-none">
                <svg xmlns="http://www.w3.org/2000/svg"width="32px" fill="#3c79e6" viewBox="0 0 22.773 22.773">
              ...
              <button type="button"
                className="border-none outline-none">
                <svg xmlns="http://www.w3.org/2000/svg"width="32px" fill="" viewBox="0 0 167.657 167.657">
